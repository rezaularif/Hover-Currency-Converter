...
export const normalizeDisabledSites = globalThis.HCCSettingsCore.normalizeDisabledSites;
...
export function collectChangedSettings(currentValues, normalizedValues) {
  return Object.fromEntries(
    Object.entries(normalizedValues).filter(([key, normalizedValue]) => {
